...
<form id="signupForm" action="" method="post">
    ...
    <input type="email" id="email" placeholder="piemers@piemers.lv" required name="email"/><br></br>
    ...
    <input type="password" id="password_conf" placeholder="••••••••" required name="password_conf"/><br></br>
    <span><small><p class="kluda" id="name_error">1</p></small></span>
